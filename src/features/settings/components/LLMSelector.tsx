      ...
      {llmContext?.textModelType == "Cloud LLM" ? (
        ...
        >
          <input
            ...
            className="w-full h-full p-2 outline-none text-md text-gray-200"
            type="text"
          />
          <button
            className="h-full px-2.5 rounded-r-lg hover:bg-gray-700 dark:hover:bg-tertiary-dark cursor-pointer"
